...
module.exports = {
   ...
   * Returns an agency
   */
  getAgency: function(network_key, cb) {
    Agency.findOne({
  ...
  /*
   * Returns an array of routes for the `network_key` specified
   */
  getRoutesByNetwork: function(network_key, cb) {
    Route.find({
      network_key: network_key
    }, cb);
  },
   ...
   */
  getRoutesById: function(network_key, route_id, cb) {
    Route.findOne({
      network_key: network_key,
      route_id: route_id
    }, cb);
  ...
  /*
   * Returns an array of routes serving the `network_key` and `stop_id` specified
   */
  getRoutesByStop: function(network_key, stop_id, cb) {
    var trip_ids = [];
    var route_ids = [];
    var routes = [];
   ...
   */
  getStops: function(network_key, stop_ids, cb) {
  ...
  /*
   * Returns an array of stops along the `route_id` for the `network_key` and `direction_id` specified
   */
  getStopsByRoute: function(network_key, route_id, direction_id, cb) {
      ...
      Trip
        .count(query, function(e, tripCount) {
          if(tripCount) {
            ...
            cb(new Error('Invalid network_key or route_id'), 'trips');
          }
        });
    }
   ...
   */
  getStoptimesByTrip: function(network_key, trip_id, cb) {
    StopTime
      .find({
          network_key: network_key,
        trip_id: trip_id
  ...
  /*
   * Returns an array of stoptimes for the `network_key`, `route_id`, `stop_id`
   * and `direction_id` specified
   */
  getStoptimesByStop: function(network_key, route_id, stop_id, direction_id, cb) {
    ...
    function checkFields(cb) {
      if(!network_key) {
        cb(new Error('No network_key specified'), 'fields');
      } else if(!stop_id) {
  ...
  /*
   * Returns an array of trips for the `network_key`, `route_id` and
   * `direction_id` specified
   */
  getTripsByRouteAndDirection: function(network_key, route_id, direction_id, service_ids, cb) {
    var query = {
      network_key: network_key,
      route_id: route_id
    };
   ...
   * for the `network_key` and `route_id` specified
   */
  findBothDirectionNames: function(network_key, route_id, cb) {
    var findDirectionName = function(network_key, route_id, direction_id, cb) {
      var query = {
        network_key: network_key,
        route_id: route_id,
        direction_id: direction_id
    ...
    findDirectionName(network_key, route_id, 0, function(northData) {
      findDirectionName(network_key, route_id, 1, function(southData) {
        var ret = {
          northData: northData,
          southData: southData
        };
  ...
  /*
   * Returns an array of shapes for the `network_key`, `route_id` and
   * `direction_id` specified
   */
  getShapesByRoute: function(network_key, route_id, direction_id, cb) {
    if(_.isFunction(direction_id)) {
      cb = direction_id;
      direction_id = null;
    }
  ...
  /*
   * Returns an array of coordinates for the `network_key`, and `route_id`
   * specified
   */
  getCoordinatesByRoute: function(network_key, route_id, cb) {
    var coordinates = [];

    module.exports.getShapesByRoute(network_key, route_id, function(err, shapes) {
      if(err) {
        Trip.find({
          network_key: network_key,
          route_id: route_id
   ...
   */
  getCalendars: function(network_key, start_date, end_date, monday, tuesday, wednesday, thursday, friday, saturday, sunday, cb) {
  ...
  /*
   * Returns feed_info for the network_key specified
   */
  getFeedInfo: function(network_key, cb) {
    FeedInfo.findOne({
      network_key: network_key
    }, cb);
  },
  ...
  /*
   * Returns an array of timetables for the `network_key` specified
   */
  getTimetablesByNetwork: function(network_key, cb) {
    Timetable.find({
      network_key: network_key
    }, cb);
  },
   ...
   */
  getTimetable: function(network_key, timetable_id, cb) {
    Timetable.findOne({
      network_key: network_key,
   ...
   */
  getRouteDirection: function(network_key, route_id, direction_id, cb) {
